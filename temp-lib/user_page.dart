                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Builder(
                          builder: (context) {
                            Widget _display_type = CtTheme.Icon.Student(Colors.black, 100.0);
                            if(tiny_db.getString("user_type") == "t"){
                              _display_type = CtTheme.Icon.Teacher(Colors.black, 100.0);
                            }
                            else if(tiny_db.getString("user_type") == "m"){
                              _display_type = CtTheme.Icon.Manager(Colors.black, 100.0);
                            }
